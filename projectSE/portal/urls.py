...
urlpatterns = [
    ...
    path('admin/home/add-procedures/', admin_procedures.create_procedure, name='add_procedure'),
    path('admin/home/add-procedure/', login_required(admin_procedures.ProcedureCreateView.as_view()), name='add_one_procedure'),
